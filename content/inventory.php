...
<body>
    ...
    <div id="sidebar">
        ...
        <!-- Inventory -->
        <a href="inventory.php" class="sidebar-link" style=" background: #f48734;color: white;">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="main-content">
        ...
        <div id="noResultsMessage" style="display: none; color: #000;">No products found...</div>

        <div class="inventory-container">
            <?php foreach ($result as $row) { ?>
                <div class="inventory-card">
                    <span class="product-name"><?php echo htmlspecialchars($row['ItemDesc']); ?></span>
                    <label class="switch">
                        <input type="checkbox" class="toggle-switch"
                            data-id="<?php echo $row['ItemID']; ?>"
                            <?php echo ($row['IsAvailable'] == 1) ? "checked" : ""; ?>
